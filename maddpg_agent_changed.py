...
LR_CRITIC = 0.03  # learning rate of the critic
...
class ReplayBuffer:
    ...
    def make_index(self, batch_size):
        np.random.seed(0)
        return [random.randint(0, len(self._storage) - 1) for _ in
                range(batch_size)]  # for the batch experience tuples are picked randomly
